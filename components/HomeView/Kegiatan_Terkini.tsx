        ...
        <div className="relative w-full overflow-hidden mt-6 h-[400px]">
          <AnimatePresence mode="wait">
            {kegiatan.length > 0 && (
              ...
              >
                <Image 
                  src={kegiatan[index].imageUrl} 
                  alt={kegiatan[index].title} 
                  width={180} 
                  height={180} 
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-800 mt-4">
                  {kegiatan[index].title}
                </h3>
                <p className="text-gray-600 text-sm md:text-base mt-4 flex-grow">
                  {kegiatan[index].description}
                </p>
              </motion.div>
            )}
          </AnimatePresence>
